Veewee::Definition.declare({
  ...
  # This apparently differs in Fusion 4. 'RedHat_64' cannot make a RHEL box.
  # allowed inputs are found in ostypes.yml under ~/lib/veewee/config/
  :os_type_id => 'CentOS',
  :iso_file => "CentOS-5.7-i386-bin-DVD-1of2.iso",
  ...
  :boot_wait => "3",
  :boot_cmd_sequence => [ '<Tab> text ks=http://webserver/ks.cfg <Enter>' ],
